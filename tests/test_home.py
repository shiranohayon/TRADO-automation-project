...
class Tests(WebDriverSetup):
    ...
    @allure.title("test_1_welcome_to_popup_with_category")
    ...
    def test_4_click_drinks_btn(self, setUp):
    ...
    def test_5_search_valid_keyword(self, setUp):
    ...
    def test_6_search_invalid_keyword(self, setUp):
        self.home_page.click_search_bar_text_field()
        self.home_page.search_bar_keyword('aaabfbfbfn')
        is_no_results_text_display = self.home_page.no_results_search_bar()
        assert is_no_results_text_display == True


    def test_7_change_to_us_language(self, setUp):
    ...
    def test_8_top_logo_redirects_home_page_from_product(self, setUp):
        self.products_page.click_product()
        self.home_page.click_top_logo()
        assert self.driver.current_url == 'https://qa.trado.co.il/'


    def test_9_promotional_banner_image_transition(self, setUp):
    ...
    def test_13_product_image(self, setUp):
        external_image = self.home_page.external_product_image()
        #get image source attribute
        self.home_page.click_external_product_image()
        sleep(3)
        inner_image = self.products_page.inner_product_image()
        # check if the external and inner image sources are equal
        assert external_image == inner_image


    def test_16_sort_price_high_to_low(self, setUp):
    ...
    def test_20_valid_text_importants(self, setUp):
